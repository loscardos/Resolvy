...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-4">
        <h3 class="mb-0">{{ trans('global.create') }} {{ trans('cruds.ticket.title_singular') }}</h3>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" rows="6">{{ old('description') }}</textarea>
                    ...
                    {{-- Right Column: Ticket Classification --}}
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('priority') ? 'is-invalid' : '' }}" name="priority" id="priority" required>
                                @foreach(App\Models\Ticket::PRIORITY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('priority', 'medium') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
